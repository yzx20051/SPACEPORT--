#pragma once
#define DEFAULT_MAGGICCODE 0x13DBAB24BA49BA //length 16 max
...
typedef struct _REQUEST_Alloce {
	DWORD ProcessId;
	ULONG allocation_type, protect;
	ULONGLONG addr;
	SIZE_T size;
} REQUEST_Alloce, * PREQUEST_Alloce;
...
NTSTATUS CallbackAlloce(PREQUEST_Alloce args);
